...
TESTS = test_default_ctor test_int_ctor test_equal test_c_str_ctor test_add test_subscript add test_times_10 test_times_digit test_multiply multiply test_factorial factorial
###############################################################
